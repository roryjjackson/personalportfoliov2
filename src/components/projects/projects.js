...
function Projects() {
  ...
  let projects = [
    ...
    {title: "Adventure Yurts", tag: "A React front-end application that is designed to showcase a start-up's modern wooden yurt design. This is our initial template before the correct information and media is available to launch their product.", img_url: "https://res.cloudinary.com/dfipoufmj/image/upload/v1669281725/pexels-kelly-13766418_etqld7.jpg", link_url: "https://adventureyurts.com/", codebase: "https://github.com/roryjjackson/reactadventureyurts"},
    {title: "MappedOut", tag: "My current project under-construction is a Rails Api back-end with a React front-end, chosen for scalability and the option to easily build an mobile app in React Native in the future. The app will align those in freelance/entrepeneurial careers with those who think traditional education is not for them.", img_url: "https://res.cloudinary.com/dfipoufmj/image/upload/v1683107312/pexels-buro-millennial-1438075_ob6gjy.jpg", link_url: "https://github.com/roryjjackson/mappedout", codebase: "https://github.com/roryjjackson/mappedout"},

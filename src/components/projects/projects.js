...
function Projects() {
  ...
  let projects = [
    {title: "Zoe and Cam 2023", tag: "A react app built to handle various functions such as RSVP", img_url: "https://res.cloudinary.com/dfipoufmj/image/upload/v1669048522/zoe_header_pic_2_nsu9ml.jpg", link_url: ""},
    ...
    {title: "Blog", tag: "My first full stack project, this implements a blog style app where all crud actions are available, as well as displaying on a map service for easier use", img_url: "https://res.cloudinary.com/dfipoufmj/image/upload/v1681827598/pexels-miguel-a%CC%81-padrin%CC%83a%CC%81n-1111370_q8bkvh.jpg", link_url: ""},
